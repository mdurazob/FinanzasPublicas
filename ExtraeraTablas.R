...
abril2020SituacionFinanciera <- filter(abril2020SituacionFinanciera, !V2 %in% 
c('Petroleros1_/','Programable', 'D. Balance no presupuestario', 'F. Recursos externos')) %>%
  select(V2, V5, V8, V11)
...
abril2020SplitedDeudaInterna <- slice(abril2020SplitedDeudaInterna, -c(1, 2, 18, 19, 20, 21, 22, 23, 24))
abril2020SplitedDeudaInterna$Concepto <- c("Suma de estructura por plazo","Largo plazo","Corto plazo","Suma de estructura por usuario", "Usuario_GobFederal", "Usuario_GobFederal_LargoPlazo", "Usuario_GobFederal_CortoPlazo", "Usuario_EmpresasProductivas", "Usuario_EmpresasProductivas_LargoPlazo", "Usuario_EmpresasProductivas_CortoPlazo", "Usuario_BancaDesarrollo", "Usuario_BancaDesarrollo_LargoPlazo", "Usuario_BancaDesarrollo_CortoPlazo", "Suma de estructuras por fuente de financiamiento", "nula")
...
colnames(abril2020DeudaInterna) <- c("Comisiones","Total", "Concepto", "Intereses")
...
write.csv(abril2020SituacionFinanciera, file ="abril2020SituacionFinanciera", fileEncoding = "UTF-8")
write.csv(abril2020DeudaExterna, file ="abril2020DeudaExterna", fileEncoding = "UTF-8")
write.csv(abril2020DeudaInterna, file ="abril2020DeudaInterna", fileEncoding = "UTF-8")
