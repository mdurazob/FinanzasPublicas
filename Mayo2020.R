...
marzo2020Resumen <- slice(marzo2020Resumen, -c(1, 2, 3, 4, 5))
...
marzo2020SplitedResumen <- data.frame(do.call("rbind", strsplit(as.character(marzo2020Resumen$Enero.abril), " ", fixed = TRUE)))
